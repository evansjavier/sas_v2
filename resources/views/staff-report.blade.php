    ...
    <div class="content">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
            <div class="my-auto mb-2">
                <h3 class="page-title mb-1">Staff Attendance Report</h3>
                <nav>
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Staff Attendance Report</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="filter-wrapper">
            ...
            <div class="list-tab">
                <ul>
                    ...
                    <li>
                        <a href="{{url('staff-report')}}" class="active">Staff Report</a>
                    </li>
                </ul>
            </div>
            <!-- /List Tab -->
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between flex-wrap pb-0">
                <h4 class="mb-3">Staff Attendance Report</h4>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                            <p class="text-dark mb-0"><a
                                                    href="javascript:void(0);">Janet</a></p>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                            <p class="text-dark mb-0"><a
                                                    href="javascript:void(0);">Daniel</a></p>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                            <p class="text-dark mb-0"><a
                                                    href="javascript:void(0);">Hellana</a></p>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                            <p class="text-dark mb-0"><a
                                                    href="javascript:void(0);">Erickson</a></p>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                            <p class="text-dark mb-0"><a
                                                    href="javascript:void(0);">Morgan</a></p>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                            <p class="text-dark mb-0"><a
                                                    href="javascript:void(0);">Aaron</a></p>
                                        </div>
                                    </div>
                                </td>
                                <td><span class="badge  badge-soft-info">95</span></td>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <a href="javascript:void(0);" class="avatar avatar-md"><img
                                                ...
                                                class="img-fluid rounded-circle" alt="img"></a>
                                        <div class="ms-2">
                                            <p class="text-dark mb-0"><a href="javascript:void(0);">Raul</a>
                                            </p>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                            <p class="text-dark mb-0"><a
                                                    href="javascript:void(0);">Edward</a></p>
                                        </div>
                                    </div>
                                </td>
