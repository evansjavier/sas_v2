    ...
    <div class="content content-two">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between mb-3">
            <div class="my-auto mb-2">
                <h4 class="page-title mb-1">Edit Student</h4>
                 <nav>
                            ...
                            <div class="row row-cols-xxl-5 row-cols-md-6">
                                ...
                                <div class="col-xxl col-xl-3 col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Number" value="AD9892434">
                                    </div>
                                </div>
                                <div class="col-xxl col-xl-3 col-md-6">
                                    <div class="mb-4">
                                        <label class="form-label">Admission Date</label>
                                        <input type="text" class="form-control datetimepicker" value="15/12/1991">
                                    </div>
                                </div>
                                <div class="col-xxl col-xl-3 col-md-6">
                                    <div class="mb-4">
                                        <label class="form-label">Roll Number</label>
                                        <input type="text" class="form-control" placeholder="Enter Number" value="35013">
                                    </div>
                                </div>
                                <div class="col-xxl col-xl-3 col-md-6">
                                    <div class="mb-4">
                                ...
                                <div class="col-xxl col-xl-3 col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter First Name" value="Ralph">
                                    </div>
                                </div>
                                <div class="col-xxl col-xl-3 col-md-6">
                                    <div class="mb-4">
                                        <label class="form-label">Last Name</label>
                                        <input type="text" class="form-control" placeholder="Enter Last Name" value="Claudia">
                                    </div>
                                </div>
                                <div class="col-xxl col-xl-3 col-md-6">
                                    <div class="mb-4">
                                ...
                                <div class="col-xxl col-xl-3 col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Number" value="+1 46548 84498">
                                    </div>
                                </div>
                                <div class="col-xxl col-xl-3 col-md-6">
                                    <div class="mb-4">
                                        <label class="form-label">Email Address</label>
                                        <input type="email" class="form-control" placeholder="Enter Email" value="jan@example.com">
                                    </div>
                                </div>
                                <div class="col-xxl col-xl-3 col-md-6">
                                    <div class="mb-4">
                                        <label class="form-label">Caste</label>
                                        <input type="text" class="form-control" placeholder="Enter Caste" value="Catholic">
                                    </div>
                                </div>
                                <div class="col-xxl col-xl-3 col-md-6">
                                    <div class="mb-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Name" value="Jerald Vicinius">
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6">
                                        <div class="mb-4">
                                            <label class="form-label">Email</label>
                                            <input type="text" class="form-control" placeholder="Enter Email" value="jera@example.com">
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6">
                                        <div class="mb-4">
                                            <label class="form-label">Phone Number</label>
                                            <input type="text" class="form-control" placeholder="Enter Phone Number" value="+1 45545 46464">
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6">
                                        <div class="mb-4">
                                            <label class="form-label">Father Occupation</label>
                                            <input type="text" class="form-control" placeholder="Enter Occupation" value="Mechanic">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Name" value="Roberta Webber">
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6">
                                        <div class="mb-4">
                                            <label class="form-label">Email</label>
                                            <input type="text" class="form-control" placeholder="Enter Email" value="robe@example.com">
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6">
                                        <div class="mb-4">
                                            <label class="form-label">Phone Number</label>
                                            <input type="text" class="form-control" placeholder="Enter Phone Number" value="+1 46499 24357">
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6">
                                        <div class="mb-4">
                                            <label class="form-label">Mother Occupation</label>
                                            <input type="text" class="form-control" placeholder="Enter Occupation" value="Homemaker">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="mb-4">
                                            <label class="form-label">Email</label>
                                            <input type="email" class="form-control" placeholder="Enter Email" value="jera@example.com">
                                        </div>
                                    </div>
                                    <div class="col-lg-3 col-md-6">
                                        <div class="mb-4">
                                    ...
                                    <div class="col-lg-3 col-md-6">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Address" value="3495 Red Hawk Road, Buffalo Lake, MN 55314">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="mb-4">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div>
                                                    ...
                                                    <a href="javascript:void(0);" class="trash-icon ms-3">Delete</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Current Address" value="3495 Red Hawk Road, Buffalo Lake, MN 55314">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        <label class="form-label">Permanent Address</label>
                                        <input type="text" class="form-control" placeholder="Enter Permanent Address" value="3495 Red Hawk Road, Buffalo Lake, MN 55314">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Name" value="Oxford Matriculation, USA">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        <label class="form-label">Address</label>
                                        <input type="text" class="form-control" placeholder="Enter Address" value="1852 Barnes Avenue, Cincinnati, OH 45202">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Name" value="Bank of America">
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="mb-4">
                                        <label class="form-label">Branch</label>
                                        <input type="text" class="form-control" placeholder="Enter Branch" value="Cincinnati">
                                    </div>
                                </div>
                                <div class="col-md-5">
                                    <div class="mb-4">
                                        <label class="form-label">IFSC Number</label>
                                        <input type="text" class="form-control" placeholder="Enter Number" value="BOA83209832">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="mb-4">
                                        <label class="form-label">Other Information</label>
                                        <textarea class="form-control" placeholder="Other Information">Depending on the specific needs of your organization or system, additional information may be collected or tracked. It's important to ensure that any data collected complies with privacy regulations and policies to protect students' sensitive information.</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
