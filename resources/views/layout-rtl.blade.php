                ...
                <div class="card bg-dark">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-xl-center justify-content-xl-between flex-xl-row flex-column">
                            ...
                            <p class="text-white d-flex align-items-center"><i class="ti ti-refresh me-1"></i>Updated Recently on 15 Jun 2024</p>
                        </div>
                    </div>
                </div>
                <!-- /Dashboard Content -->
                ...
                <div class="row flex-fill">
                    ...
                    <div class="col-sm-6 d-flex flex-column">
                        <div class="bg-success-800 p-3 br-5 text-center flex-fill mb-4 pb-0  owl-height bg-01">
                            <div class="owl-carousel student-slider-rtl h-100">
                    ...
                    <div class="col-sm-6 d-flex flex-column">
                        <div class="bg-info p-3 br-5 text-center flex-fill mb-4 pb-0 owl-height bg-02">
                            <div class="owl-carousel teacher-slider-rtl h-100">
                                <div class="item h-100">
                                    <div class="d-flex justify-content-between flex-column h-100">
                                        <div>
            ...
            <div class="col-xxl-4 col-md-12 d-flex flex-column">
                ...
                <div class="card flex-fill">
                    ...
                    <div class="card-body pb-1">
                        <div class="owl-carousel link-slider-rtl">
                            <div class="item">
