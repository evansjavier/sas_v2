				...
				<div class="d-flex align-items-center justify-content-between flex-wrap p-3 bg-white pb-0 mb-4">
					...
					<div class="d-flex align-items-center flex-wrap">
						...
						<div class="d-flex align-items-center bg-white border rounded-2 p-1 mb-3 me-2">
							<a href="{{url('tickets')}}" class="btn btn-icon bg-light btn-sm me-1 primary-hover"><i class="ti ti-list-tree"></i></a>
							<a href="{{url('ticket-grid')}}" class="active btn btn-icon btn-sm primary-hover"><i class="ti ti-grid-dots"></i></a>
						</div>
					...
					<div class="col-xl-8 col-xxl-9">
						...
						<div class="card">
							...
							<div class="card-body p-3 pb-0">
								...
								<div class="bg-light-300 p-3 rounded mb-3">
									<p class="text-gray mb-1">Last Comment from Support Agent <span class="text-dark"> Angio</span></p>
									<p class="text-gray mb-2">Switch on the side panel & update the OS,  Login in to the device manager and update the password</p>
									<a href="#" class="d-inline-flex align-items-center text-primary fw-medium" data-bs-toggle="offcanvas" data-bs-target="#ticket-reply"><i class="ti ti-reload me-1"></i>Reply</a>
								</div>
							</div>
						</div>
						<!-- /Ticket List -->
