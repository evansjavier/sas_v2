		...
		<div class="content content-two">
			...
			<div class="d-md-flex d-block align-items-center justify-content-between mb-3">
				<div class="my-auto mb-2">
					<h3 class="page-title mb-1">Edit Invoice</h3>
					<nav>
						<ol class="breadcrumb mb-0">
							...
							<li class="breadcrumb-item">
								<a href="{{url('teachers')}}">Finance & Accounts</a>
							</li>
												...
												<div class="row">
													...
													<div class="col-lg-3 col-md-6">
														<div class="mb-3">
															...
															<input type="text" class="form-control" placeholder="Enter Invoice Number" value="INV681537">
														</div>
													</div>
													<div class="col-lg-3 col-md-6">
														<div class="mb-3">
															...
															<div class="input-icon position-relative">
																...
																<input type="text" class="form-control datetimepicker" placeholder="Select Date" value="25-04-2024">
															</div>
														</div>
													</div>
													<div class="col-lg-3 col-md-6">
														<div class="mb-3">
															...
															<div class="input-icon position-relative">
																...
																<input type="text" class="form-control datetimepicker" placeholder="Select Date" value="30-04-2024">
															</div>
														</div>
													</div>
												</div>
													...
													<div class="col-lg-3 col-md-6">
														<div class="mb-3">
															...
															<select class="select">
																...
																<option>Library Donation</option>
															</select>
														</div>
													</div>
													<div class="col-lg-3 col-md-6">
														<div class="mb-3">
															...
															<input type="number" class="form-control" placeholder="Enter Quantity" value="2">
														</div>
													</div>
													<div class="col-lg-2">
														<div class="mb-3">
															<a href="#" class="btn btn-primary"><i class="ti ti-plus me-2"></i>Add to Bill</a>
														</div>
													</div>
													<div class="col-md-12">
																...
																<table class="table">
																	...
																	<tbody>
																		<tr>
																			<td>Uniform</td>
																			<td>
																				<input type="number" class="form-control" placeholder="0" value="100">
																			</td>
																			<td>
																				<input type="text" class="form-control" placeholder="0" value="500">
																			</td>
																			<td>
																			...
																			<td>$450</td>
																			<td>
																				<a href="#" class="delete-invoive-list" data-bs-toggle="modal" data-bs-target="#delete-modal"><i class="ti ti-trash"></i></a>
																			</td>
																		</tr>
																		<tr>
																			<td>Description</td>
